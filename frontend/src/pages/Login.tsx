          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-98 pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-98 pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
                placeholder="••••••••"
                required
              />
            </div>
